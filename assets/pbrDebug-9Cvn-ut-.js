import{t as e}from"./shaderStore-CU9wbwKM.js";import"./ltcHelperFunctions-CAKFkyHa.js";import"./mainUVVaryingDeclaration-DALlmvbf.js";var t=`pbrFragmentExtraDeclaration`,n=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`subSurfaceScatteringFunctions`,i=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`pbrHelperFunctions`,o=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`pbrDirectLightingSetupFunctions`,c=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`pbrDirectLightingFalloffFunctions`,u=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`pbrDirectLightingFunctions`,f=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`pbrBlockNormalGeometric`,m=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`pbrBlockImageProcessing`,g=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`pbrDebug`,v=`#if DEBUGMODE>0
