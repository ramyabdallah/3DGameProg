import{t as e}from"./shaderStore-CU9wbwKM.js";import"./sceneUboDeclaration-BuRWXJKB.js";import"./meshUboDeclaration-obtZCwYh.js";var t=`gaussianSplattingVertexDeclaration`,n=`attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`gaussianSplattingUboDeclaration`,i=`#include<sceneUboDeclaration>
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`gaussianSplatting`,o=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
