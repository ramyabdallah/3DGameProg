import{f as e}from"./math.scalar.functions-Cad0mLhT.js";import{t}from"./shaderStore-CU9wbwKM.js";import"./clipPlaneFragmentDeclaration-BUJlKfnT.js";import"./logDepthDeclaration-eFNbOVvg.js";import"./fogFragmentDeclaration-CEdCViDP.js";import"./logDepthFragment-8hhk9mSs.js";import"./fogFragment-BUJyD0nt.js";import"./clipPlaneFragment-Ctu9V-v5.js";import"./helperFunctions-09iHkbfD.js";import"./reflectionFunction-DUzaAYdY.js";import"./imageProcessingDeclaration-CeX8G9m-.js";import"./lightUboDeclaration-DdCA8H3O.js";import"./shadowsFragmentFunctions-C8Eqr6XG.js";import"./imageProcessingFunctions-Dr_UXdma.js";import"./pbrBRDFFunctions-Bvlk57WW.js";import"./harmonicsFunctions-CCeQHUhB.js";import"./oitFragment-BeElEH7w.js";import"./pbrDebug-CTV0k5vW.js";import"./samplerFragmentDeclaration-ZHogXP-r.js";import"./pbrIBLFunctions-CKoeYiER.js";import"./hdrFilteringFunctions-DNNn3rpM.js";import"./openpbrUboDeclaration-RIweWZkU.js";import"./openpbrSubsurfaceLayerData-DaEPtkbT.js";var n=`openpbrFragmentSamplersDeclaration`,r=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;t.IncludesShadersStoreWGSL[n]||(t.IncludesShadersStoreWGSL[n]=r);var i=`openpbrNormalMapFragmentMainFunctions`,a=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;t.IncludesShadersStoreWGSL[i]||(t.IncludesShadersStoreWGSL[i]=a);var o=`openpbrNormalMapFragmentFunctions`,s=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;t.IncludesShadersStoreWGSL[o]||(t.IncludesShadersStoreWGSL[o]=s);var c=`openpbrConductorReflectance`,l=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;t.IncludesShadersStoreWGSL[c]||(t.IncludesShadersStoreWGSL[c]=l);var u=`openpbrAmbientOcclusionFunctions`,d=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;t.IncludesShadersStoreWGSL[u]||(t.IncludesShadersStoreWGSL[u]=d);var f=`openpbrVolumeFunctions`,p=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;t.IncludesShadersStoreWGSL[f]||(t.IncludesShadersStoreWGSL[f]=p);var m=`openpbrNormalMapFragment`,h=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;t.IncludesShadersStoreWGSL[m]||(t.IncludesShadersStoreWGSL[m]=h);var g=`openpbrBlockNormalFinal`,_=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[g]||(t.IncludesShadersStoreWGSL[g]=_);var v=`openpbrBaseLayerData`,y=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;t.IncludesShadersStoreWGSL[v]||(t.IncludesShadersStoreWGSL[v]=y);var b=`openpbrCoatLayerData`,x=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;t.IncludesShadersStoreWGSL[b]||(t.IncludesShadersStoreWGSL[b]=x);var S=`openpbrThinFilmLayerData`,C=`#ifdef THIN_FILM
...
#endif
`;t.IncludesShadersStoreWGSL[S]||(t.IncludesShadersStoreWGSL[S]=C);var w=`openpbrFuzzLayerData`,T=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[w]||(t.IncludesShadersStoreWGSL[w]=T);var E=`openpbrAmbientOcclusionData`,D=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;t.IncludesShadersStoreWGSL[E]||(t.IncludesShadersStoreWGSL[E]=D);var O=`openpbrBackgroundTransmission`,k=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;t.IncludesShadersStoreWGSL[O]||(t.IncludesShadersStoreWGSL[O]=k);var A=`openpbrEnvironmentLighting`,j=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;t.IncludesShadersStoreWGSL[A]||(t.IncludesShadersStoreWGSL[A]=j);var M=`openpbrDirectLightingInit`,N=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[M]||(t.IncludesShadersStoreWGSL[M]=N);var P=`openpbrDirectLighting`,F=`#ifdef LIGHT{X}
...
#endif
`;t.IncludesShadersStoreWGSL[P]||(t.IncludesShadersStoreWGSL[P]=F);var I=`openpbrBlockPrePass`,L=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[I]||(t.IncludesShadersStoreWGSL[I]=L);var R=e({openpbrPixelShaderWGSL:()=>V}),z=`openpbrPixelShader`,B=`#define OPENPBR_FRAGMENT_SHADER
...
`;t.ShadersStoreWGSL[z]||(t.ShadersStoreWGSL[z]=B);var V={name:z,shader:B};export{R as t};