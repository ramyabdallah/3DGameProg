import{f as e}from"./math.scalar.functions-Cad0mLhT.js";import{t}from"./shaderStore-CU9wbwKM.js";import"./clipPlaneFragmentDeclaration-CPdR7Gg-.js";import"./logDepthDeclaration-C8SJ9jRT.js";import"./fogFragmentDeclaration-bHewI4QB.js";import"./logDepthFragment-CjCwy93R.js";import"./fogFragment-D7r_foS5.js";import"./clipPlaneFragment-BjC7hRrA.js";import"./helperFunctions-CW0DYx7W.js";import"./bumpFragmentMainFunctions-DgHimCGY.js";import"./samplerFragmentDeclaration-DibkNfGm.js";import"./bumpFragmentFunctions-bvzFMvcv.js";import"./pbrIBLFunctions-CR1khC0k.js";import"./pbrBRDFFunctions-Bjo5EC08.js";import"./reflectionFunction-KgPA06RN.js";import"./bumpFragment-c5IUQJRh.js";import"./harmonicsFunctions-5Fx0fLLn.js";import"./clusteredLightingFunctions-duH7jOq4.js";import"./imageProcessingDeclaration-C9UeLksc.js";import"./lightFragmentDeclaration-J05Zq-Pt.js";import"./lightUboDeclaration-C6tT3mGP.js";import"./shadowsFragmentFunctions-CQRvAu5T.js";import"./imageProcessingFunctions-Bgm6x3HZ.js";import"./lightFragment--Wgx2xWg.js";import"./pbrUboDeclaration-D-eapmoi.js";import"./oitFragment-D5LAmFAX.js";import"./pbrDebug-9Cvn-ut-.js";import"./hdrFilteringFunctions-BxMzKuJg.js";import"./decalFragment-CMz59pJJ.js";var n=`pbrFragmentDeclaration`,r=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;t.IncludesShadersStore[n]||(t.IncludesShadersStore[n]=r);var i=`samplerFragmentAlternateDeclaration`,a=`#ifdef _DEFINENAME_
...
#endif
#endif
`;t.IncludesShadersStore[i]||(t.IncludesShadersStore[i]=a);var o=`pbrFragmentSamplersDeclaration`,s=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;t.IncludesShadersStore[o]||(t.IncludesShadersStore[o]=s);var c=`pbrBlockAlbedoOpacity`,l=`struct albedoOpacityOutParams
...
`;t.IncludesShadersStore[c]||(t.IncludesShadersStore[c]=l);var u=`pbrBlockReflectivity`,d=`struct reflectivityOutParams
...
`;t.IncludesShadersStore[u]||(t.IncludesShadersStore[u]=d);var f=`pbrBlockAmbientOcclusion`,p=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;t.IncludesShadersStore[f]||(t.IncludesShadersStore[f]=p);var m=`pbrBlockAlphaFresnel`,h=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;t.IncludesShadersStore[m]||(t.IncludesShadersStore[m]=h);var g=`pbrBlockAnisotropic`,_=`#ifdef ANISOTROPIC
...
#endif
`;t.IncludesShadersStore[g]||(t.IncludesShadersStore[g]=_);var v=`pbrBlockReflection`,y=`#ifdef REFLECTION
...
#endif
`;t.IncludesShadersStore[v]||(t.IncludesShadersStore[v]=y);var b=`pbrBlockSheen`,x=`#ifdef SHEEN
...
#endif
`;t.IncludesShadersStore[b]||(t.IncludesShadersStore[b]=x);var S=`pbrBlockClearcoat`,C=`struct clearcoatOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStore[S]||(t.IncludesShadersStore[S]=C);var w=`pbrBlockIridescence`,T=`struct iridescenceOutParams
...
#endif
`;t.IncludesShadersStore[w]||(t.IncludesShadersStore[w]=T);var E=`pbrBlockSubSurface`,D=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStore[E]||(t.IncludesShadersStore[E]=D);var O=`pbrBlockReflectance0`,k=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;t.IncludesShadersStore[O]||(t.IncludesShadersStore[O]=k);var A=`pbrClusteredLightingFunctions`,j=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;t.IncludesShadersStore[A]||(t.IncludesShadersStore[A]=j);var M=`pbrBlockNormalFinal`,N=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStore[M]||(t.IncludesShadersStore[M]=N);var P=`pbrBlockLightmapInit`,F=`#ifdef LIGHTMAP
...
#endif
`;t.IncludesShadersStore[P]||(t.IncludesShadersStore[P]=F);var I=`pbrBlockGeometryInfo`,L=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;t.IncludesShadersStore[I]||(t.IncludesShadersStore[I]=L);var R=`pbrBlockReflectance`,z=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;t.IncludesShadersStore[R]||(t.IncludesShadersStore[R]=z);var B=`pbrBlockDirectLighting`,V=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;t.IncludesShadersStore[B]||(t.IncludesShadersStore[B]=V);var H=`pbrBlockFinalLitComponents`,U=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;t.IncludesShadersStore[H]||(t.IncludesShadersStore[H]=U);var W=`pbrBlockFinalUnlitComponents`,G=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;t.IncludesShadersStore[W]||(t.IncludesShadersStore[W]=G);var K=`pbrBlockFinalColorComposition`,q=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;t.IncludesShadersStore[K]||(t.IncludesShadersStore[K]=q);var J=`pbrBlockPrePass`,Y=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.IncludesShadersStore[J]||(t.IncludesShadersStore[J]=Y);var X=e({pbrPixelShader:()=>$}),Z=`pbrPixelShader`,Q=`#define PBR_FRAGMENT_SHADER
...
`;t.ShadersStore[Z]||(t.ShadersStore[Z]=Q);var $={name:Z,shader:Q};export{X as t};