import{f as e}from"./math.scalar.functions-Cad0mLhT.js";import{t}from"./shaderStore-CU9wbwKM.js";import"./clipPlaneFragmentDeclaration-BUJlKfnT.js";import"./logDepthDeclaration-eFNbOVvg.js";import"./fogFragmentDeclaration-CEdCViDP.js";import"./logDepthFragment-8hhk9mSs.js";import"./fogFragment-BUJyD0nt.js";import"./clipPlaneFragment-Ctu9V-v5.js";import"./helperFunctions-09iHkbfD.js";import"./decalFragment-B4-XaeeW.js";import"./reflectionFunction-DUzaAYdY.js";import"./imageProcessingDeclaration-CeX8G9m-.js";import"./lightUboDeclaration-DdCA8H3O.js";import"./shadowsFragmentFunctions-C8Eqr6XG.js";import"./imageProcessingFunctions-Dr_UXdma.js";import"./lightFragment-Ds6xUAHZ.js";import"./pbrUboDeclaration-B1tUN9mP.js";import"./pbrBRDFFunctions-Bvlk57WW.js";import"./harmonicsFunctions-CCeQHUhB.js";import"./oitFragment-BeElEH7w.js";import"./pbrDebug-CTV0k5vW.js";import"./samplerFragmentDeclaration-ZHogXP-r.js";import"./pbrIBLFunctions-CKoeYiER.js";import"./hdrFilteringFunctions-DNNn3rpM.js";import"./bumpFragmentMainFunctions-nk-4uuKv.js";import"./bumpFragmentFunctions-CmHpMI5_.js";import"./bumpFragment-Du6veICo.js";var n=`samplerFragmentAlternateDeclaration`,r=`#ifdef _DEFINENAME_
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[n]||(t.IncludesShadersStoreWGSL[n]=r);var i=`pbrFragmentSamplersDeclaration`,a=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;t.IncludesShadersStoreWGSL[i]||(t.IncludesShadersStoreWGSL[i]=a);var o=`pbrBlockAlbedoOpacity`,s=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;t.IncludesShadersStoreWGSL[o]||(t.IncludesShadersStoreWGSL[o]=s);var c=`pbrBlockReflectivity`,l=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;t.IncludesShadersStoreWGSL[c]||(t.IncludesShadersStoreWGSL[c]=l);var u=`pbrBlockAmbientOcclusion`,d=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;t.IncludesShadersStoreWGSL[u]||(t.IncludesShadersStoreWGSL[u]=d);var f=`pbrBlockAlphaFresnel`,p=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[f]||(t.IncludesShadersStoreWGSL[f]=p);var m=`pbrBlockAnisotropic`,h=`#ifdef ANISOTROPIC
...
#endif
`;t.IncludesShadersStoreWGSL[m]||(t.IncludesShadersStoreWGSL[m]=h);var g=`pbrBlockReflection`,_=`#ifdef REFLECTION
...
#endif
`;t.IncludesShadersStoreWGSL[g]||(t.IncludesShadersStoreWGSL[g]=_);var v=`pbrBlockSheen`,y=`#ifdef SHEEN
...
#endif
`;t.IncludesShadersStoreWGSL[v]||(t.IncludesShadersStoreWGSL[v]=y);var b=`pbrBlockClearcoat`,x=`struct clearcoatOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStoreWGSL[b]||(t.IncludesShadersStoreWGSL[b]=x);var S=`pbrBlockIridescence`,C=`struct iridescenceOutParams
...
#endif
`;t.IncludesShadersStoreWGSL[S]||(t.IncludesShadersStoreWGSL[S]=C);var w=`pbrBlockSubSurface`,T=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStoreWGSL[w]||(t.IncludesShadersStoreWGSL[w]=T);var E=`pbrBlockNormalFinal`,D=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[E]||(t.IncludesShadersStoreWGSL[E]=D);var O=`pbrBlockLightmapInit`,k=`#ifdef LIGHTMAP
...
#endif
`;t.IncludesShadersStoreWGSL[O]||(t.IncludesShadersStoreWGSL[O]=k);var A=`pbrBlockGeometryInfo`,j=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[A]||(t.IncludesShadersStoreWGSL[A]=j);var M=`pbrBlockReflectance`,N=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[M]||(t.IncludesShadersStoreWGSL[M]=N);var P=`pbrBlockDirectLighting`,F=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;t.IncludesShadersStoreWGSL[P]||(t.IncludesShadersStoreWGSL[P]=F);var I=`pbrBlockFinalLitComponents`,L=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[I]||(t.IncludesShadersStoreWGSL[I]=L);var R=`pbrBlockFinalUnlitComponents`,z=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;t.IncludesShadersStoreWGSL[R]||(t.IncludesShadersStoreWGSL[R]=z);var B=`pbrBlockFinalColorComposition`,V=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;t.IncludesShadersStoreWGSL[B]||(t.IncludesShadersStoreWGSL[B]=V);var H=`pbrBlockPrePass`,U=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[H]||(t.IncludesShadersStoreWGSL[H]=U);var W=e({pbrPixelShaderWGSL:()=>q}),G=`pbrPixelShader`,K=`#define PBR_FRAGMENT_SHADER
...
`;t.ShadersStoreWGSL[G]||(t.ShadersStoreWGSL[G]=K);var q={name:G,shader:K};export{W as t};